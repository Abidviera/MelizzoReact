    ...
    <div className="contact">
      ...
      <section className="contact__main">
        <div className="contact__container">
          ...
          {/* Contact Cards + Info */}
          <div className="contact__layout" ref={addRef(0)}>
            {/* Info Column */}
            <div className="contact__info">
              ...
              <div className="contact__cards">
                {[
                  ...
                  <div className="contact__card" key={i} ref={addRef(1 + i)}>
              ...
              {/* WhatsApp CTA */}
              <div className="contact__whatsapp-block" ref={addRef(5)}>
              ...
              {/* Business Hours */}
              <div className="contact__hours" ref={addRef(6)}>
            ...
            {/* Form Column */}
            <div className="contact__form-wrapper" ref={addRef(7)}>
              ...
              {submitted ? (
                <div className="contact__success" ref={addRef(8)}>
      ...
      <section className="contact__faq" id="faq">
        <div className="contact__container">
          <div className="contact__faq-header" ref={addRef(9)}>
          ...
          <div className="contact__faq-list" ref={addRef(10)}>
            {faqData.map((item, i) => (
              <div
          ...
          {/* Still need help */}
          <div className="contact__faq-still" ref={addRef(11)}>
